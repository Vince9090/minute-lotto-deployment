...
docker compose down
rm -rf ./backend/master/data/* ./backend/master/data/.gitkeep
rm -rf ./backend/slave/data/* ./backend/slave/data/.gitkeep
chmod 044 ./backend/master/conf/mysql.conf.cnf
chmod 044 ./backend/slave/conf/mysql.conf.cnf
